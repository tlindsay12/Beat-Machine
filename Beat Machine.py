...
snare = mixer.Sound('Sounds\MURDA SNARE EASTER EGG.wav')
kick = mixer.Sound('Sounds\MURDA KICK ISOLATION.wav')
cymbal = mixer.Sound('Sounds\FM OHH.wav')
clap = mixer.Sound('Sounds\MURDA CLAP BAGUETTE.wav')
tom = mixer.Sound('Sounds\Lo Tom1.wav')
